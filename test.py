...
def test_connection():
    load_dotenv()
    print("--- DEBUG INFO ---")
    print(f"DB_HOST loading as: {os.getenv('DB_HOST', 'localhost')}")
    print(f"DB_USER loading as: {os.getenv('DB_USER', 'root')}")
    print(f"DB_NAME loading as: {os.getenv('DB_NAME', 'internship_db')}")
